        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 flex flex-col md:flex-row items-center justify-between gap-10">
          <div>
            ...
            <p className="text-white/40 text-sm max-w-sm leading-relaxed">
              Cele mai iubite piese din colecția noastră, alese de sute de cliente. Calitate confirmată.
            </p>
          </div>
          <div className="flex gap-10 md:gap-16 text-center shrink-0">
            <div>
              ...
              <p className="text-white/40 text-[10px] tracking-widest uppercase">Produse bestseller</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white/40 text-[10px] tracking-widest uppercase">Alese de cliente</p>
            </div>
          </div>
        </div>
      </div>
