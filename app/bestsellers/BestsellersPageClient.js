...
export default function BestsellersPageClient({ bestsellerProducts, categories, availableCategories }) {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="flex gap-10 md:gap-16 text-center shrink-0">
            <div>
              ...
              <p className="text-white/40 text-[10px] tracking-widest uppercase">{t('bestsellers.products')}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-white/40 text-[10px] tracking-widest uppercase">{t('bestsellers.chosenBy')}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center gap-2 text-xs text-gray-400 tracking-widest uppercase">
            ...
            <span>/</span>
            <span className="text-black">{t('bestsellers.title')}</span>
          </nav>
        </div>
      </div>
