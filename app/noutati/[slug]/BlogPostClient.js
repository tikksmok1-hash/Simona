      ...
      <div className="border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <nav className="flex items-center gap-2 text-xs text-gray-400 tracking-widest uppercase">
            ...
            <span>/</span>
            <Link href="/noutati" className="hover:text-black transition-colors">{t('blog.title')}</Link>
            <span>/</span>
            <span className="text-black truncate max-w-[180px]">{localize(post, 'title', lang)}</span>
          </nav>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div key={i}>
                ...
                return (
                  <div className="relative w-full aspect-video overflow-hidden bg-neutral-100 rounded-lg mt-8">
                    <iframe
                      ...
                      title={localize(section, 'heading', lang) || 'Video'}
                      frameBorder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowFullScreen
                      className="absolute inset-0 w-full h-full"
              ...
              {section.image && !section.videoUrl && (
                <div className="relative w-full aspect-[16/7] overflow-hidden bg-neutral-100 mt-8">
                  <Image
                    src={section.image}
                    alt={localize(section, 'heading', lang)}
                    fill
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <span className="text-[10px] tracking-widest uppercase text-gray-400">{t('blog.share')}</span>
            <a
        ...
        <section className="border-t border-gray-100 py-16 bg-neutral-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <p className="text-[10px] tracking-[0.5em] uppercase text-gray-400 mb-3">{t('blog.continueReading')}</p>
              <h2 className="font-serif text-3xl text-black font-light">{t('blog.similarArticles')}</h2>
            </div>
                ...
                <Link key={rpost.id} href={`/noutati/${rpost.slug}`} className="group flex flex-col overflow-hidden bg-white">
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    <div className="flex items-center gap-3 text-[10px] tracking-widest uppercase text-gray-400 mb-3">
                      ...
                      <span>·</span>
                      <span>{rpost.readTime} {t('blog.readTime')}</span>
                    </div>
