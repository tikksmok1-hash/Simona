        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20">
            ...
            <div className="flex-1 relative">
              ...
              >
                ...
                {zoomActive && mainImage?.url && (() => {
                  ...
                  // Route through Next.js image optimizer to avoid raw blob fetch
                  const optimizedUrl = `/_next/image?url=${encodeURIComponent(mainImage.url)}&w=1920&q=85`;
                  return (
                    <div
          ...
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-3 gap-3 mb-8 pb-8 border-b border-gray-100">
              {[
                { icon: <svg className="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" /></svg>, label: localizeSettings(siteSettings, 'badge1Label', lang) || t('detail.fastDelivery'), sub: localizeSettings(siteSettings, 'badge1Sub', lang) || t('detail.deliveryDays') },
                { icon: <svg className="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3" /></svg>, label: localizeSettings(siteSettings, 'badge2Label', lang) || t('detail.return'), sub: localizeSettings(siteSettings, 'badge2Sub', lang) || t('detail.returnDays') },
                { icon: <svg className="w-6 h-6 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" /></svg>, label: localizeSettings(siteSettings, 'badge3Label', lang) || t('detail.securePay'), sub: localizeSettings(siteSettings, 'badge3Sub', lang) || t('detail.securePayDesc') },
              ].map((item) => (
