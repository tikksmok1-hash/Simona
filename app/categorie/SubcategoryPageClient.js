...
export default function SubcategoryPageClient({ category, subcategory, categoryProducts, activeSubcategories, subslug }) {
    ...
    <div className="min-h-screen bg-white pt-[112px] md:pt-[170px]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav className="flex items-center space-x-2 text-sm">
          ...
          <span className="text-neutral-300">/</span>
          <span className="text-black">{localize(subcategory, 'name', lang)}</span>
        </nav>
      </div>
      ...
      <div className="bg-neutral-50 border-b border-neutral-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-light text-black mb-4">
            {localize(subcategory, 'name', lang)}
          </h1>
          <p className="text-neutral-500 max-w-2xl mx-auto">{localize(subcategory, 'description', lang)}</p>
        </div>
      </div>
