...
// Lighter include for product cards (no reviews, no heavy data)
const productCardInclude = {
  ...
  category: { select: { id: true, name: true, nameRu: true, nameEn: true, slug: true } },
  subcategory: { select: { id: true, name: true, nameRu: true, nameEn: true, slug: true } },
};
