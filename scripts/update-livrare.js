...
const data = {
  ...
  deliveryOptions: [
    { title: 'Livrare Standard', subtitle: '3–5 zile lucrătoare', price: '70 MDL', description: 'Disponibilă în toată Moldova. Produsul ajunge ambalat elegant, gata de oferit cadou.' },
    { title: 'Ridicare din Magazin', subtitle: 'Disponibil imediat', price: 'Gratuit', description: 'Ridici comanda din showroom-ul nostru de pe str. Ion Creanță 58, Chișinău. Program: Luni–Vineri 9:00–19:00, Sâmbătă–Duminică 9:00–17:00.' },
  ],
  steps: [
...
async function main() {
  ...
  console.log('✓ Updated livrare page to JSON format');
}
